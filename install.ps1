...
# Side Effects: Writes the managed claude-skills surface under $env:USERPROFILE\.codex and removes temporary download files.
...
try {
    ...
    $InstalledBinary = Join-Path $env:USERPROFILE ".codex\claude-skills.exe"
